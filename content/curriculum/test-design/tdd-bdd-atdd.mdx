...
│  Audience: Business + Team          Artefact: Executable specification  │
│                                                                         │
│  "What does DONE look like? Give me an example."                        │
│                                                                         │
│  Rule + Examples → Automate → Living Documentation                      │
│  e.g. decision table of discount rules, wired to CI                     │
└─────────────────────────┬───────────────────────────────────────────────┘
                          │ ATDD examples become BDD scenarios
                          ▼
┌─────────────────────────────────────────────────────────────────────────┐
│  BDD — Behaviour-Driven Development                                     │
│  Audience: Dev + QA + Business      Artefact: Three-amigos conversation │
│                                                                         │
│  "Walk me through a concrete example of this feature."                  │
│                                                                         │
│  Three-amigos meeting → Concrete examples → (optionally) .feature file  │
│  The meeting is the practice; Gherkin/Cucumber is one tool for it       │
└─────────────────────────┬───────────────────────────────────────────────┘
                          │ BDD examples become TDD red tests
                          ▼
┌─────────────────────────────────────────────────────────────────────────┐
│  TDD — Test-Driven Development                                          │
│  Audience: Developer                Artefact: Red-green-refactor loop   │
│                                                                         │
│  "Write the test first, make it pass, then improve the design."         │
│                                                                         │
│  RED (write failing test) → GREEN (simplest code to pass) →            │
│  REFACTOR (improve design without breaking the test) → repeat           │
└─────────────────────────────────────────────────────────────────────────┘

The three compose: SbE conversation → BDD examples → TDD red tests → code.
Each artefact from the outer layer survives as a regression guard.
```
</Diagram>
