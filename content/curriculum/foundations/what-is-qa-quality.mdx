...
> Quality is not a property of an artifact in isolation. It is value to some person, in some context — which means two stakeholders can correctly disagree about whether the same build is high quality.
...
│                    ISO/IEC 25010:2023                           │
│                                                                 │
│  FUNCTIONAL                    NON-FUNCTIONAL (experiential)    │
│  ─────────────────             ────────────────────────────     │
│  Functional Suitability        Performance Efficiency           │
│  · completeness                Compatibility                    │
│  · correctness                 Interaction Capability           │
│  · appropriateness               (incl. Accessibility)         │
│                                Reliability                      │
│                                Security                         │
│                                Maintainability                  │
│                                Flexibility                      │
