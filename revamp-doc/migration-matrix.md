...
| — | non-functional/observability-for-testers | non-functional | shipped | n/a | Knowledge P5 (#187). New topic — no legacy precursor. layer: patterns. PR: knowledge-p5/187-observability-for-testers. |
...
| — | ai-llm-qa/llm-fundamentals-for-testers | ai-llm-qa | shipped | n/a | Knowledge P6 (#189). New topic — no legacy precursor. layer: patterns. PR: knowledge-p6/189-llm-fundamentals-for-testers. |
| — | ai-llm-qa/ai-observability-and-drift | ai-llm-qa | shipped | n/a | Knowledge P6 (#194). New topic — no legacy precursor. layer: patterns. PR: knowledge-p6/194-ai-observability-and-drift. |
