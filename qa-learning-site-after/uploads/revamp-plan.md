...
> This is the single execution document for the revamp. It synthesizes the four research/decision docs in this folder (excluding `revamp-knowledge/`, which is reference material) into a phased build plan grounded in the current codebase.
>
